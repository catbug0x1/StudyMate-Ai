...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 12l-2 2 2.828 2.828a1 1 0 010 1.414L10 21m5-16l2.293 2.293a1 1 0 010 1.414L15 12l-2 2 2.828 2.828a1 1 0 010 1.414L15 21" />
  </svg>
);

export const FileUploadIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const BeakerIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 2l10 0" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 2v15a5 5 0 0010 0V2" />
...
export const BrainIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.871 14.342c-1.393-.424-2.122-1.12-2.122-1.844 0-1.041 1.79-1.884 4-1.884s4 .843 4 1.884c0 .724-.729 1.42-2.122 1.844m-1.756 2.053C6.32 17.433 4.871 18.5 4.871 19.5c0 1.041 1.79 1.884 4 1.884s4-.843 4-1.884c0-1-.875-1.745-2.244-2.122M19.129 14.342c1.393-.424 2.122-1.12 2.122-1.844 0-1.041-1.79-1.884-4-1.884s-4 .843-4 1.884c0 .724.729 1.42 2.122 1.844m1.756 2.053c1.632 1.038 3.129 2.125 3.129 3.105 0 1.041-1.79 1.884-4 1.884s-4-.843-4-1.884c0-.98.875-1.745 2.244-2.122M12 9V3M12 9c-1.333.333-2 1.333-2 2.5 0 1.041.895 1.884 2 1.884s2-.843 2-1.884C14 10.333 13.333 9.333 12 9z" />
    </svg>
);

export const ClipboardCopyIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
